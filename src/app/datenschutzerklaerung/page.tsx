  ...
  return (
    <div className="page">
      ...
      <div className={`${textFont.className} privacy-notice-imprint`}>
        ...
        <p>
          Anbieter ist die Host Europe GmbH, Hansestraße 111, 51149, Köln
          (nachfolgend Host Europe) Wenn Sie unsere Website besuchen, erfasst
          Host Europe verschiedene Logfiles inklusive Ihrer IP-Adressen. Details
          entnehmen Sie der Datenschutzerklärung von Host Europe:
          <a href="https://www.hosteurope.de/AGB/Datenschutzerklaerung/">
            https://www.hosteurope.de/AGB/Datenschutzerklaerung/
          </a>
          .<br />
          <br />
          Die Verwendung von Host Europe erfolgt auf Grundlage von Art. 6 Abs. 1
          ...
          auf Informationen im Endgerät des Nutzers (z. B. für
